...
PARAMETERS = 'lr'+str(Learning_Rate) + '_Epoch'+str(Epoch) + '_lambda'+str(LAMBDA) + '_set1_5_6_7'
PATH_PARAMETERS = './model_static/checkpoint_' + PARAMETERS + '.pth.tar'
...
# =================Data Processing========================
# Get all the data
X_np, Y_np, _, _ = get_train_data_static()
    ...
    for step, (input, dose) in enumerate(train_loader):
        ...
        if count % 4000 == 0:
            ...
            if count % 20000 == 0:
                ...
                print("Epoch: {} Iteration: {}, Loss: {}, Loss_val : {}, Accuracy: {} %".format(epoch+1, count, round(loss.data.item(), 4), round(loss_val, 4), round(r2, 4)))
